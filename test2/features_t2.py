...
features_df.to_csv(
    current_folder / "bearing1_features_labeled.csv",
    index=False
)
...
plt.title("Bearing 1 Feature Analysis - Dataset 2")
plt.legend()
plt.grid(True)

# Save graph
plt.savefig(
    current_folder / "bearing1_features.png"
)
